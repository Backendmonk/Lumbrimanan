        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-16">
            <div className="md:w-1/2 relative">
               ...
               <img src="pages/src/homeKemurnian.jpg" alt="Lumbrimanan Solution" className="relative z-10 w-full rounded-2xl shadow-2xl" />
            </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/3 order-1 lg:order-2 flex justify-center">
              <div className="relative">
                ...
                <img 
                  src="pages/src/niluhkartini.jpeg" 
